...
export default function App() {
  ...
  const filteredPublications = publications.filter((pub) => {
    ...
    const matchesSearch =
      ...
      pub.journal.toLowerCase().includes(normalizedQuery);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 sm:gap-6">
            ...
            >
              ...
              <span className="hidden sm:inline">공식 홈</span>
          ...
          <div className="p-6 sm:p-8 lg:p-10 -mt-16 relative z-10">
            <div className="flex flex-col lg:flex-row gap-8 items-start">
              <div className="relative shrink-0 mx-auto lg:mx-0">
                <div className="w-36 h-36 rounded-2xl bg-gradient-to-tr from-brand-600 to-emerald-500 p-1 shadow-md">
                  <div className="w-full h-full rounded-xl bg-slate-900 flex flex-col items-center justify-center text-center px-2 relative overflow-hidden">
                    ...
                    <span className="font-serif font-black text-xl text-white tracking-widest">정 택 수</span>
                    <span className="text-[10px] text-gray-300 font-mono tracking-wider">{profile.englishName}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 text-center lg:text-left space-y-3">
                <div>
                  <h1 className="text-3xl sm:text-4xl font-serif text-gray-900 font-bold tracking-tight">
                    {profile.name} <span className="font-sans text-xl font-normal text-gray-500">대체의학 연구가 & 경영인</span>
                  </h1>
                  <p className="text-sm font-medium text-brand-700 flex items-center justify-center lg:justify-start gap-1.5 mt-1">
                    <GraduationCap className="w-4.5 h-4.5" />
                    <span>전통 국선도 수련과 심신 안정 연구</span>
                  </p>
                </div>
            ...
            {profile.researchInterests.map((interest, idx) => (
              ...
              >
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">{interest}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className="col-span-1 lg:col-span-7 space-y-8">
            <div className="flex bg-gray-100 p-1 rounded-xl">
              ...
              >
                통합 학술 연구 목록 ({publications.length})
              </button>
              <button
                ...
                >
                  <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-3xs space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                      <div>
                        <h3 className="text-lg font-serif font-bold text-gray-900">대표 학술 저작 아카이브</h3>
                        <p className="text-xs text-gray-400 mt-0.5">
                          정택수 연구자의 논문, 보고서, 교재를 카테고리별로 확인할 수 있습니다.
                        </p>
                      </div>
                      ...
                      {filteredPublications.length === 0 ? (
                        ...
                        filteredPublications.map((pub) => {
                          ...
                          return (
                            <div
                              key={pub.id}
                              className="border border-gray-100 rounded-xl p-4 hover:border-brand-200 transition-all bg-white shadow-3xs"
                            >
                              <div className="flex items-start justify-between gap-3">
                                <div>
                                  ...
                                  <p className="text-xs text-gray-500 mt-1">
                                    저자: {pub.authors} | 학술 매체: {pub.journal}
                                  </p>
                                </div>
                              </div>
                              ...
                              <div className="mt-3 flex items-center justify-between">
                                ...
                                >
                                  <span>{isExpanded ? '초록 닫기' : '초록 보기'}</span>
                              ...
                              <AnimatePresence>
                                {isExpanded && (
                                  ...
                                  >
                                    <div className="bg-gray-50 p-3.5 rounded-lg border border-gray-100 mt-3 text-xs leading-relaxed text-gray-600 font-sans">
          ...
          <div id="ai-chat-section" className="col-span-1 lg:col-span-5 space-y-4">
            <div className="bg-white p-4.5 rounded-2xl border border-gray-100 shadow-3xs">
              ...
              <p className="text-xs text-gray-500 leading-relaxed">
                전통 단전호흡, 심신 안정, 업무 스트레스 완화에 대해 질문할 수 있는 정적 상담 채널입니다.
              </p>
            </div>
      ...
      <footer className="bg-white border-t border-gray-100 py-12 mt-16 text-center">
        <div className="max-w-3xl mx-auto px-4 space-y-3">
          <p className="font-serif italic text-lg text-gray-600 leading-normal">
            "호흡은 몸과 마음을 다시 연결하는 가장 가까운 수련입니다."
          </p>
          ...
          <div className="pt-6 border-t border-gray-100/60 mt-6 text-[11px] text-gray-400 font-mono">
            &copy; 2026 TAESU JEONG. All Academic Somatic Research Rights Reserved. /{' '}
            <a href="https://soom4u.co.kr/" target="_blank" rel="noopener noreferrer" className="underline hover:text-brand-800">
              soom4u.co.kr
            </a>
          </div>
        </div>
